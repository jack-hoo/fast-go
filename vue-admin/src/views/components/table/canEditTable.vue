...
<template>
    <div>
        <Table :ref="refs" :columns="columnsList" :data="thisTableData"  highlight-row border @on-current-change="currentChange" @on-selection-change="onSelectionChange" >
            <p slot="footer">
                <slot name="page"></slot>
            </p>
        </Table>
...
export default {
    ...
    methods: {
        ...
        currentChange(currentRow,oldCurrentRow) {
            this.$emit('select-change',currentRow,oldCurrentRow)
        },
        onSelectionChange(selection) {
            this.$emit('on-perm-select-change',selection)
        }
    },
    watch: {
        value (data) {
