...
<script>
    import {
        add_my_sys_authority, get_sys_authority_list, delete_sys_authority, update_sys_authority,
    ...
    export default {
        ...
        methods:{
            update_sys_authority(){
                update_sys_authority(this.sysAuthority).then(res => {
            ...
            delete_sys_authority(index){
                let ids = [];
                ids.push(this.sysAuthorityList[index].id);
                delete_sys_authority(ids).then(res => {
                    this.get_sys_authority_list();
                }).catch(error => {
                        console.log(error);
                });
            ...
            get_sys_authority_list(){
                //如果角色是管理员则调用管理员的接口
                get_sys_authority_list(this.params).then(res => {
