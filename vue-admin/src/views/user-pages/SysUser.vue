...
<script>
    import {
        add_my_sys_user, update_my_sys_user, delete_my_sys_user, get_my_sys_user_list
    } from '../../api/SysUserApi';
    ...
    export default {
        ...
        methods:{
            update_sys_user(){
                update_my_sys_user(this.sysUser).then(res => {
            ...
            delete_sys_user(index){
                delete_my_sys_user(ids).then(res => {
                      this.get_sys_user_list();
                }).catch(error => {
                    console.log(error);
                });
            ...
            get_sys_user_list(){
                get_my_sys_user_list(this.params).then(res => {
