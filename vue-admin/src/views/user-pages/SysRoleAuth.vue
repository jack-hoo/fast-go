...
<script>
    import {
        add_my_sys_role_auth, update_my_sys_role_auth, delete_my_sys_role_auth, get_my_sys_role_auth_list
    ...
    export default {
        ...
        methods:{
            update_sys_role_auth(){
                update_my_sys_role_auth(this.sysRoleAuth).then(res => {
            ...
            delete_sys_role_auth(index){
                delete_my_sys_role_auth(ids).then(res => {
                      this.get_sys_role_auth_list();
                }).catch(error => {
                    console.log(error);
                });
            ...
            get_sys_role_auth_list(){
                get_my_sys_role_auth_list(this.params).then(res => {
